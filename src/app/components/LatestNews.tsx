...
const NewsSection = () => {
  return (
    <section className="bg-[#F7F8FA] py-12 px-4 md:px-10 lg:px-30">
      ...
      <div className="mt-16 bg-[#F7F8FA]">
        <div className="max-w-6xl grid md:grid-cols-3 items-center py-10">
          ...
          <div className="space-y-2 pt-8 text-blue-600 font-medium text-base md:text-lg">
            <p>
              <a href="mailto:sales@theninehertz.com" className="hover:underline">
                sales@theninehertz.com
              </a>
            </p>
            <p>
              <a href="tel:+13153814100" className="hover:underline">
                USA: +1-315-381-4100
              </a>
            </p>
          </div>
